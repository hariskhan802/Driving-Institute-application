function init_sidebar() {
    var a = function() {
        $RIGHT_COL.css("min-height", window.innerHeight + 200 + "px");
...
function init_flot_chart() {
    if ("undefined" != typeof $.plot) {
        ...
        $("#chart_plot_01").length && ('' + ("Plot1"), $.plot($("#chart_plot_01"), [a, b], g)), $("#chart_plot_02").length && ('' + ("Plot2"), $.plot($("#chart_plot_02"), [{
            label: "Email Sent",
            data: d,
            lines: {
        ...
        }], h)), $("#chart_plot_03").length && ('' + ("Plot3"), $.plot($("#chart_plot_03"), [{
            label: "Registrations",
            data: e,
            lines: {
                fillColor: "rgba(150, 202, 89, 0.12)"
...
function init_starrr() {
    "undefined" != typeof starrr && ('' + ("init_starrr"), $(".stars").starrr(), $(".stars-existing").starrr({
        rating: 4
...
function init_JQVmap() {
    "undefined" != typeof jQuery.fn.vectorMap && ('' + ("init_JQVmap"), $("#world-map-gdp").length && $("#world-map-gdp").vectorMap({
        map: "world_en",
...
function init_chart_doughnut() {
    if ("undefined" != typeof Chart && ('' + ("init_chart_doughnut"), $(".canvasDoughnut").length)) {
        var a = {
            type: "doughnut",
...
function init_gauge() {
    if ("undefined" != typeof Gauge) {
        '' + ("init_gauge [" + $(".gauge-chart").length + "]"), '' + ("init_gauge");
        var a = {
            lines: 12,
            angle: 0,
            lineWidth: .4,
...
function init_sparklines() {
    "undefined" != typeof jQuery.fn.sparkline && ('' + ("init_sparklines"), $(".sparkline_one").sparkline([2, 4, 3, 4, 5, 4, 5, 4, 3, 4, 5, 6, 4, 5, 6, 3, 5, 4, 5, 4, 5, 4, 3, 4, 5, 6, 7, 5, 4, 3, 5, 6], {
        type: "bar",
        height: "125",
        barWidth: 13,
        colorMap: {
...
function init_parsley() {
    if ("undefined" != typeof parsley) {
        '' + ("init_parsley"), $("parsley:field:validate", function() {
            a()
...
function init_select2() {
    "undefined" != typeof select2 && ('' + ("init_toolbox"), $(".select2_single").select2({
...
function init_wysiwyg() {
    function b(a, b) {
        var c = "";
        "unsupported-file-type" === a ? c = "Unsupported format " + b : '' + ("error uploading file", a, b), $('<div class="alert"> <button type="button" class="close" data-dismiss="alert">&times;</button><strong>File upload error</strong> ' + c + " </div>").prependTo("#alerts")
    }
    "undefined" != typeof $.fn.wysiwyg && ('' + ("init_wysiwyg"), $(".editor-wrapper").each(function() {
        var a = $(this).attr("id");
        $(this).wysiwyg({
    ...
    if ("undefined" != typeof $.fn.cropper) {
        ...
        $('[data-toggle="tooltip"]').tooltip(), a.on({
            ...
            "crop.cropper": function(a) {
                '' + (a.type, a.x, a.y, a.width, a.height, a.rotate, a.scaleX, a.scaleY)
            },
...
function init_InputMask() {
    "undefined" != typeof $.fn.inputmask && ('' + ("init_InputMask"), $(":input").inputmask())
}

function init_ColorPicker() {
    "undefined" != typeof $.fn.colorpicker && ('' + ("init_ColorPicker"), $(".demo1").colorpicker(), $(".demo2").colorpicker(), $("#demo_forceformat").colorpicker({
        format: "rgba",
        horizontal: !0
...
function init_IonRangeSlider() {
    "undefined" != typeof $.fn.ionRangeSlider && ('' + ("init_IonRangeSlider"), $("#range_27").ionRangeSlider({
        type: "double",
        min: 1e6,
        max: 2e6,
        grid: !0,
...
function init_daterangepicker() {
    if ("undefined" != typeof $.fn.daterangepicker) {
        ...
        var a = function(a, b, c) {
                '' + (a.toISOString(), b.toISOString(), c), $("#reportrange span").html(a.format("MMMM D, YYYY") + " - " + b.format("MMMM D, YYYY"))
            },
            b = {
        ...
        $("#reportrange span").html(moment().subtract(29, "days").format("MMMM D, YYYY") + " - " + moment().format("MMMM D, YYYY")), $("#reportrange").daterangepicker(b, a), $("#reportrange").on("show.daterangepicker", function() {
            ...
            '' + ("apply event fired, start/end dates are " + b.startDate.format("MMMM D, YYYY") + " to " + b.endDate.format("MMMM D, YYYY"))
...
function init_daterangepicker_right() {
    if ("undefined" != typeof $.fn.daterangepicker) {
        ...
        var a = function(a, b, c) {
                '' + (a.toISOString(), b.toISOString(), c), $("#reportrange_right span").html(a.format("MMMM D, YYYY") + " - " + b.format("MMMM D, YYYY"))
            },
            b = {
                startDate: moment().subtract(29, "days"),
                endDate: moment(),
...
function init_daterangepicker_single_call() {
    "undefined" != typeof $.fn.daterangepicker && ('' + ("init_daterangepicker_single_call"), $("#single_cal1").daterangepicker({
        singleDatePicker: !0,
        singleClasses: "picker_1"
    }, function(a, b, c) {
        '' + (a.toISOString(), b.toISOString(), c)
...
function init_daterangepicker_reservation() {
    "undefined" != typeof $.fn.daterangepicker && ('' + ("init_daterangepicker_reservation"), $("#reservation").daterangepicker(null, function(a, b, c) {
        '' + (a.toISOString(), b.toISOString(), c)
...
function init_SmartWizard() {
    "undefined" != typeof $.fn.smartWizard && ('' + ("init_SmartWizard"), $("#wizard").smartWizard(), $("#wizard_verticle").smartWizard({
...
function init_validator() {
    "undefined" != typeof validator && ('' + ("init_validator"), validator.message.date = "not a real date", $("form").on("blur", "input[required], input.optional, select.required", validator.checkField).on("change", "select.required", validator.checkField).on("keypress", "input[required][pattern]", validator.keypress), $(".multi.required").on("keyup blur", "input", function() {
...
function init_PNotify() {
    "undefined" != typeof PNotify && ('' + ("init_PNotify"), new PNotify({
        title: "PNotify",
        type: "info",
...
function init_CustomNotification() {
    if ('' + ("run_customtabs"), "undefined" != typeof CustomTabs) {
        '' + ("init_CustomTabs");
        var a = 10;
...
function init_EasyPieChart() {
    if ("undefined" != typeof $.fn.easyPieChart) {
        '' + ("init_EasyPieChart"), $(".chart").easyPieChart({
...
function init_charts() {
    if ('' + ("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart) {
        if ('' + ("init_charts"), Chart.defaults.global.legend = {
                enabled: !1
            }, $("#canvas_line").length) {
...
function init_compose() {
    "undefined" != typeof $.fn.slideToggle && ('' + ("init_compose"), $("#compose, .compose-close").click(function() {
        $(".compose").slideToggle()
    }))
}
...
function init_DataTables() {
    if ('' + ("run_datatables"), "undefined" != typeof $.fn.DataTable) {
        '' + ("init_DataTables");
        var a = function() {
...
function init_morris_charts() {
    "undefined" != typeof Morris && ('' + ("init_morris_charts"), $("#graph_bar").length && Morris.Bar({
        element: "graph_bar",
        data: [{
            device: "iPhone 4",
            geekbench: 380
...
$(window).load(function() {
    ...
    jQuery('.cus-aside').height(jQuery('.right_col').height() + 23);

    setInterval(function(){
        
        $('select:not(.ui-datepicker-month, .ui-datepicker-year)').change();
        $('.cus-aside ').height(document.body.scrollHeight )    
    }, 1)

});
jQuery(document).on('click', '.nav.side-menu a', function(e){
	e.preventDefault();
	jQuery(this).siblings('.nav.child_menu').slideToggle();
});
