    ...
    <script src="{{ url('/public/js') }}/ocLazyLoad.js"></script>

    <script src="{{ url('/public/js') }}/angular-ui-router.min.js"></script>
    <script src="{{ url('/frontend/js') }}/app.js"></script>
    <script src="{{ url('public') }}/js/sweet-alert/sweetalert.js"></script>
    
    <script src="{{ url('public') }}/vendors/jqueryui/jquery-ui.js"></script>
