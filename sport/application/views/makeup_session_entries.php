        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <table class="mdl-data-table ml-table-striped ml-table-bordered mdl-js-data-table is-upgraded">
                    ...
                    <tbody>
                        <?php
                        if (!empty($enroll_makeup)) {
                            foreach ($enroll_makeup as $makeup) {
                                ?>
                                <tr>
                                    <td><?= $makeup['child_name'] ?></td>
                                    <td><?= $makeup['club_name'] ?></td>
                                    <td><?= $makeup['level_name'] ?></td>
                                    <td><?= $makeup['venue_name'] ?></td>
                                    <td><?= $makeup['date'] ?></td>
                                    <td><?= $makeup['day'] ?></td>
                                    <td><?= $makeup['start_time'] ?></td>
                                    <td><?= $makeup['end_time'] ?></td>
                                </tr>
                                <?php
                            }
                        }
