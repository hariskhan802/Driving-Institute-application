    ...
    <div class="page-content" style="min-height:595px">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    <div class="card-body">   
                        <form action="<?php echo site_url('/admin/general-settings/save-restriction/') ?>" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                    <h1>Staff Access Restrictions</h1>
                                </div>
                            ...
                            <div class="row">
                                <div class="card-body">
                                    <div class="row" id="filters">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-2">
                                            <label>Select Venue</label> 
                                            <select class="form-control" id="staff_id" name="staff" required="">
                                                ...
                                                foreach ($restrictions as $restriction) {
                                                    ...
                                                    <div class="noti_box col-md-12">
                                                        <div class="col-md-2 pull-left">
                                                            <?php echo $restriction['club_name']; ?>
                                                            <input type="hidden" name="clubs[]" value="<?php echo $restriction['club_id']; ?>"/>
                                                        </div>
                                                        <div class="col-md-2 pull-left">
                                                            <?php echo $restriction['program_name']; ?>
                                                            <input type="hidden" name="programs[]" value="<?php echo $restriction['program_id']; ?>"/>
                                                        </div>
                                                        <div class="col-md-2 pull-left">
                                                            <?php echo $restriction['venue_name']; ?>
                                                            <input type="hidden" name="venue[]" value="<?php echo $restriction['venue_id']; ?>"/>
                                                        </div>
                                                        <div class="col-md-2 pull-left">
                                                            <?php echo $restriction['staff_name']; ?>
                                                            <input type="hidden" name="staff[]" value="<?php echo $restriction['staff_id']; ?>"/>
                                                        </div>
                                                        <div class="col-md-2 pull-left">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-2 col-2 pull-left">
                                <button type="submit" class="btn btn-circle btn-warning ">SAVE RESTRICTIONS</button>
                            </div>
...
<script>
    $(document).ready(function () {
        ...
        $("#add_notification").on('click', function () {
            ...
            var staff_text = $("#staff_id").find("option:selected").text();
            ...
            if (isValid) {
                var element = '<div class="noti_box col-md-12">' +
                        ...
                        '</div>' +
                        '<div class="col-md-2 pull-left">' + staff_text +
