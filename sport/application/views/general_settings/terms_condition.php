    ...
    <div class="page-content" style="min-height:595px">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    <div class="card-body">   
                        <form action="<?php echo site_url('/admin/general-settings/save-terms-condition') ?>" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div id="append_news" class="col-md-12">
                                            ...
                                            if (!empty($terms_and_conditions)) {
                                                foreach ($terms_and_conditions as $new) {
                                                    ?>
                            ...
                            <div class="col-lg-1 col-md-1 col-sm-1 col-1">
                                <button type="submit" class="btn btn-circle btn-warning ">SAVE TERMS & CONDITIONS</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        $("#add_restriction").on('click', function () {
            ...
            if (text == "") {
                ...
                var elmn = '<div class="col-md-12 box_news">' +
                        ...
                        '<input type="hidden" name="terms[]" value="' + text + '"/>' +
