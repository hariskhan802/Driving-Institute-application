    ...
    window.onload = function () {
        var chart = new CanvasJS.Chart("chartContainer", {
            ...
            data: [{
                ...
                {
                    type: "column",
                    name: "My Netball Club",
                    legendText: "My Netball Club",
                    axisYType: "secondary",
                    showInLegend: true,
                    dataPoints: [
                        {label: "Term1", y: <?= $clubs['swim_count']; ?>},
                ...
                {
                    type: "column",
                    name: "My Holiday Camp",
                    legendText: "My Holiday Camp",
                    axisYType: "secondary",
                    showInLegend: true,
                    dataPoints: [
                        {label: "Term1", y: <?= $clubs['swim_count']; ?>},
