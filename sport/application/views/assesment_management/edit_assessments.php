                    ...
                    <div class="card-body ">
                        ...
                        <div class="day-select">
                            ...
                            <div class="row">
                                ...
                                <?php //d($assessments); ?>
                                <form action="<?php echo site_url('/assessment_management/update_assessment') ?>" method="post" id="form_time">

                                    <input type="hidden" name="select_day" value="<?= $assessments['day']; ?>"/>
                                    <input type="hidden" name="assessement_id" value="<?= $assessement_id; ?>"/>
...
<script>
    ...
    $(window).on('load', function () {
        ...
        setTimeout(function () {
            ...
            var days = "<?php echo $days[$assessments['day']]; ?>";
            $('select[name="day"]').find("option[value='" + days + "']").attr("selected", true);
            $.ajax({
                type: 'post',
                url: "<?php echo site_url('/admin/assessment-management/find-dates') ?>",
                data: {days: days, terms: terms},
                ...
                success: function (res) {
                    $("#dat_box").html(res);
                    $("#select_date").val("<?= $assessments['date'] ?>");
                    setTimeout(function () {
                        $(document).find(".yellow_box[data-date='<?= $assessments['date'] ?>']").addClass("active_box");
                    }, 400)
