    ...
    <div class="page-content" style="min-height:596px">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    <div class="card-body ">
                        <form action="<?php echo site_url('/admin/assessment-management/save-makeup-assessment'); ?>" method="POST">
                            <div class="row">
                            ...
                            <div class="day-select">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-3 pull-left">
                                    ...
                                    <select class="form-control" name="first_day" required="">
                                        <?php
                            ...
                            <div class="day-select">
                                <div class="col-lg-3 col-md-3 col-sm-3 col-3 pull-left">
                                    ...
                                    <select class="form-control" name="venue_id_two" required="">
                                        <?php
                                        echo print_dropdown($venues);
                                        ?>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-3 pull-left">
                                    <label>Select Day</label>
                                    <select class="form-control" name="second_day" required="">
                                        <?php
                                        echo print_dropdown($days);
                                        ?>
                                    </select>
