    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class="row">
                    <div class="col-md-6">
                        <div class="page-title">SESSION CREATION</div>
                    </div>
                    <div class="col-md-3">
                    </div>
                    <div class="col-md-3">
        ...
        <form action="<?php echo site_url("/admin/session-management/save-session") ?>" method='post'>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-3">
                                    ...
                                    <select class="form-control" id="term_drp" disabled="disabled" name="term" required="">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-3">
                                    ...
                                    <input type="text" name="session_name" id="session_name" class="form-control" placeholder="Enter Session Name" required="">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-3 level_drp">
                    ...
                    <div class="col-md-12">
                        <button type="submit" class="btn btn-circle btn-warning black " id="add_extra_weeks" style="display: none;">Add Weeks</button>
                        <br/>
                        <br/>
                        <br/>
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="pull-right">
                        <button type="submit" class="btn btn-circle btn-warning ">SAVE SESSION</button>
                    </div>
                </div>
...
//            })
            ...
            $("#level_drp").on('change', function () {
                ...
                var club = $("#club_drp").find("option:selected").val();
            ...
            $('#term_drp').on('change', function () {
                ...
                sessionStorage.weeks = 1;
            });
            $("#club_drp").on('change', function () {
                if ($(this).val() == "4") {
                    $(".level_drp").hide();
                    $("#add_extra_weeks").show();
                    $("#level_drp").removeAttr('required');
                } else {
                    $("#add_extra_weeks").hide();
                    $(".level_drp").show();
                    $("#level_drp").attr('required', true);
                }
                $.ajax({
                    type: 'post',
...
//            });
            ...
            function addHolidayWeekRows(num_of_weeks = 0){
                ...
                for (var i = 1; i <= num_of_weeks; i++) {
                    var element = '<div class="row by_date_select" data-week="WEEK' + i + '" data-week_id="' + i + '">'
                            ...
                            + '<select name="end_merdian" class="form-control">'
            ...
            $("#add_extra_weeks").on('click', function (e) {
                e.preventDefault();
                var row = $(".by_date_select").length + 1;
                addHolidayWeekExtraRows(row);
            });
        });
        ...
        function addHolidayWeekExtraRows(i) {
            event.preventDefault();
            var element = '<div class="row by_date_select" data-week="WEEK' + i + '" data-week_id="' + i + '">'
                    + '<div class="col-md-12">'
                    + '<div class="card-box">'
