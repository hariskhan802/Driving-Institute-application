...
<html lang="en">
    ...
    <body class="login-page">
        <div class="col-md-4 col-centered margin-top-70">
            ...
            <form class="form-horizontal form-material" method="post" id="loginform" action="<?php echo site_url('/admin/checklogin/') ?>">
                ...
                <div class="form-ar">
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                            ...
                            <input class="form-control" type="email" name="email" required="" value="<?php echo (isset($_COOKIE['userlogin'])) ? $_COOKIE['userlogin'] : "" ?>" placeholder="Email Address">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                            <label>Enter Password</label>
                            <input class="form-control" name="password" type="password" required="" value="<?php echo (isset($_COOKIE['userpass'])) ? $_COOKIE['userpass'] : "" ?>" placeholder="Password">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="checkbox checkbox-primary pull-left p-t-0">
                                <input id="checkbox-signup" value="1" name="remember" type="checkbox" <?php echo (isset($_COOKIE['userlogin'])) ? 'checked=""' : "" ?>>
                                <label for="checkbox-signup">Remember me </label>
                            </div>

                            <!--<a href="<?= site_url('/forgot-password') ?>" id="to-recover" class="text-dark pull-right"><i class="fa fa-lock m-r-5"></i> Forgot password?</a>-->
                    ...
                    <div class="form-group text-center m-t-20">
                        ...
                        <div class="col-xs-12">
                            ...
                            <button class="btn btn-circle btn-warning btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light" type="submit">Login</button>
